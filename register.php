...
<head> 
    ...
    <style>
        ...
        .wrapper{ width: 360px; padding: 20px; color:white }
        .background-image {
    position: relative;
    width: 100%;
    height: 100vh;
...
?>
    ...
    <div class="wrapper">
        <h2>Sign Up</h2>
        <p>Please enter your Email Id to Signup.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
                <label>Email ID  </label>
                <input type="text"  placeholder ="Email Id" name="Email Id" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
